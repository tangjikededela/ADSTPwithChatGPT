...
# Q1. What is the trend in the number of children looked after?
# # Set the pipelines
pipelines = CT.special_datastory_pipelines_for_Scottish_government_report
Xcolname = "Year"; ycolname = "looked-after children"
X = data.Year; y = data[ycolname]  # Features and Target variable
pipelines.segmentedregression_fit(X, y, Xcolname, ycolname, level=1,
             graph=False, base=False, r2=False, p=False,
             breakpointnum=5, governmentdrug=False, governmentchild=True)
